...
my_batch_size=64 # 바꿔가며 입력
my_learning_rate=1 # 바꿔가며 입력
...
class make_model():
    ...
    def make_model(self):
        ...
        history = model.fit(X_train, y_train, batch_size=my_batch_size, epochs=50, validation_data=(X_test, y_test), callbacks=[checkpoint, early_stopping])
